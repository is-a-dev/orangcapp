...
class FAQDropdown(nextcord.ui.Select):
    def __init__(self):
        options: List[nextcord.SelectOption] = [
                ...
                nextcord.SelectOption(
                    label="Why does my domain keep redirects to is-a.dev website?", value="redirect"
                ),
                nextcord.SelectOption(
                    label="How long does it take for my domain to be approved?", value="waittime"
                ),
                nextcord.SelectOption(
                ...
                nextcord.SelectOption(
                    label="Can I be maintainer/helper?", value="staff"
                ),
                nextcord.SelectOption(
                    label="Why are my records not being deployed?", value="record_not_deployed"
                ),
                nextcord.SelectOption(
                    label="I accidently leaked my email?", value="leaked",
                ),
                nextcord.SelectOption(
                    label="My DNS records are not showing up, even after 24 hours.", value="DNS_record_not_showing_up"
                ),
                nextcord.SelectOption(
